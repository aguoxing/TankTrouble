...
type Command struct {
	...
	MsgKey         string   `protobuf:"bytes,1,opt,name=msgKey,proto3" json:"msgKey"`
	MsgVal         string   `protobuf:"bytes,2,opt,name=msgVal,proto3" json:"msgVal"`
	...
	GameStatus     int32    `protobuf:"varint,5,opt,name=gameStatus,proto3" json:"gameStatus"`
	MoveStatus     int32    `protobuf:"varint,6,opt,name=moveStatus,proto3" json:"moveStatus"`
	IsMoveForward  int32    `protobuf:"varint,7,opt,name=isMoveForward,proto3" json:"isMoveForward"`
	IsMoveBackward int32    `protobuf:"varint,8,opt,name=isMoveBackward,proto3" json:"isMoveBackward"`
	IsRotateLeft   int32    `protobuf:"varint,9,opt,name=isRotateLeft,proto3" json:"isRotateLeft"`
	IsRotateRight  int32    `protobuf:"varint,10,opt,name=isRotateRight,proto3" json:"isRotateRight"`
	IsFire         int32    `protobuf:"varint,11,opt,name=isFire,proto3" json:"isFire"`
	MazeMap        *MazeMap `protobuf:"bytes,12,opt,name=mazeMap,proto3" json:"mazeMap"`
	Players        []*Tank  `protobuf:"bytes,13,rep,name=players,proto3" json:"players"`
	Player         *Tank    `protobuf:"bytes,14,opt,name=player,proto3" json:"player"`
	Bullet         *Bullet  `protobuf:"bytes,15,opt,name=bullet,proto3" json:"bullet"`
}
...
func (x *Command) GetMsgKey() string {
	if x != nil {
		return x.MsgKey
	}
	return ""
...
func (x *Command) GetMsgVal() string {
	if x != nil {
		return x.MsgVal
	}
	return ""
...
func (x *Command) GetGameStatus() int32 {
	if x != nil {
		return x.GameStatus
	}
	return 0
...
func (x *Command) GetMoveStatus() int32 {
	if x != nil {
		return x.MoveStatus
	}
	return 0
...
func (x *Command) GetIsMoveForward() int32 {
	if x != nil {
		return x.IsMoveForward
	}
	return 0
}

func (x *Command) GetIsMoveBackward() int32 {
	if x != nil {
		return x.IsMoveBackward
	}
	return 0
}

func (x *Command) GetIsRotateLeft() int32 {
	if x != nil {
		return x.IsRotateLeft
	}
	return 0
}

func (x *Command) GetIsRotateRight() int32 {
	if x != nil {
		return x.IsRotateRight
	}
	return 0
}

func (x *Command) GetIsFire() int32 {
	if x != nil {
		return x.IsFire
	}
	return 0
...
func (x *Command) GetPlayers() []*Tank {
	if x != nil {
		return x.Players
	}
	return nil
...
var file_game_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x59, 0x22, 0xe2, 0x03, 0x0a, 0x07, 0x43, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x73, 0x67, 0x4b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x73, 0x67, 0x4b, 0x65, 0x79, 0x12, 0x16, 0x0a, 0x06,
	0x6d, 0x73, 0x67, 0x56, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x73,
	0x67, 0x56, 0x61, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x18, 0x03,
	...
	,
...
var file_game_proto_depIdxs = []int32{
	...
	9,  // 11: Command.players:type_name -> Tank
	9,  // 12: Command.player:type_name -> Tank
	10, // 13: Command.bullet:type_name -> Bullet
	5,  // 14: MazeMap.GridWallsEntry.value:type_name -> Wall
