    ...
    switch (tag >>> 3) {
      ...
      case 8: {
        ...
        if (key === undefined || value === undefined)
          throw new Error("Invalid data for map: gridWalls");
        values[key] = value;
        bb.limit = outerLimit;
        break;
      }
...
export interface Command {
  ...
  gameStatus?: number;
  moveStatus?: number;
  isMoveForward?: number;
  isMoveBackward?: number;
  isRotateLeft?: number;
  isRotateRight?: number;
  isFire?: number;
  mazeMap?: MazeMap;
  players?: Tank[];
  player?: Tank;
...
export function encodeCommand(message: Command): Uint8Array {
  let bb = popByteBuffer();
  _encodeCommand(message, bb);
  return toUint8Array(bb);
}

function _encodeCommand(message: Command, bb: ByteBuffer): void {
  // optional string msgKey = 1;
  let $msgKey = message.msgKey;
  if ($msgKey !== undefined) {
    writeVarint32(bb, 10);
    writeString(bb, $msgKey);
  }

  // optional string msgVal = 2;
  let $msgVal = message.msgVal;
  if ($msgVal !== undefined) {
    writeVarint32(bb, 18);
    writeString(bb, $msgVal);
  }
  ...
  let $gameStatus = message.gameStatus;
  if ($gameStatus !== undefined) {
    writeVarint32(bb, 40);
    writeVarint64(bb, intToLong($gameStatus));
  }

  // optional int32 moveStatus = 6;
  let $moveStatus = message.moveStatus;
  if ($moveStatus !== undefined) {
    writeVarint32(bb, 48);
    writeVarint64(bb, intToLong($moveStatus));
  }

  // optional int32 isMoveForward = 7;
  let $isMoveForward = message.isMoveForward;
  if ($isMoveForward !== undefined) {
    writeVarint32(bb, 56);
    writeVarint64(bb, intToLong($isMoveForward));
  }

  // optional int32 isMoveBackward = 8;
  let $isMoveBackward = message.isMoveBackward;
  if ($isMoveBackward !== undefined) {
    writeVarint32(bb, 64);
    writeVarint64(bb, intToLong($isMoveBackward));
  }

  // optional int32 isRotateLeft = 9;
  let $isRotateLeft = message.isRotateLeft;
  if ($isRotateLeft !== undefined) {
    writeVarint32(bb, 72);
    writeVarint64(bb, intToLong($isRotateLeft));
  }

  // optional int32 isRotateRight = 10;
  let $isRotateRight = message.isRotateRight;
  if ($isRotateRight !== undefined) {
    writeVarint32(bb, 80);
    writeVarint64(bb, intToLong($isRotateRight));
  }

  // optional int32 isFire = 11;
  let $isFire = message.isFire;
  if ($isFire !== undefined) {
    writeVarint32(bb, 88);
    writeVarint64(bb, intToLong($isFire));
  }

  // optional MazeMap mazeMap = 12;
  let $mazeMap = message.mazeMap;
  if ($mazeMap !== undefined) {
    writeVarint32(bb, 98);
    let nested = popByteBuffer();
  ...
  // optional Tank player = 14;
  let $player = message.player;
  if ($player !== undefined) {
    writeVarint32(bb, 114);
    let nested = popByteBuffer();
    _encodeTank($player, nested);
    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  }

  // optional Bullet bullet = 15;
  let $bullet = message.bullet;
  if ($bullet !== undefined) {
    writeVarint32(bb, 122);
    let nested = popByteBuffer();
    _encodeBullet($bullet, nested);
    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  }
...
export function decodeCommand(binary: Uint8Array): Command {
  return _decodeCommand(wrapByteBuffer(binary));
}

function _decodeCommand(bb: ByteBuffer): Command {
  let message: Command = {} as any;
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string msgKey = 1;
      case 1: {
        message.msgKey = readString(bb, readVarint32(bb));
        break;
      }

      // optional string msgVal = 2;
      case 2: {
        message.msgVal = readString(bb, readVarint32(bb));
        break;
      }
      ...
      // optional int32 gameStatus = 5;
      case 5: {
        message.gameStatus = readVarint32(bb);
        break;
      }

      // optional int32 moveStatus = 6;
      case 6: {
        message.moveStatus = readVarint32(bb);
        break;
      }

      // optional int32 isMoveForward = 7;
      case 7: {
        message.isMoveForward = readVarint32(bb);
        break;
      }

      // optional int32 isMoveBackward = 8;
      case 8: {
        message.isMoveBackward = readVarint32(bb);
        break;
      }

      // optional int32 isRotateLeft = 9;
      case 9: {
        message.isRotateLeft = readVarint32(bb);
        break;
      }

      // optional int32 isRotateRight = 10;
      case 10: {
        message.isRotateRight = readVarint32(bb);
        break;
      }

      // optional int32 isFire = 11;
      case 11: {
        message.isFire = readVarint32(bb);
        break;
      }
      ...
      case 15: {
        let limit = pushTemporaryLength(bb);
        message.bullet = _decodeBullet(bb);
        bb.limit = limit;
        break;
      }
